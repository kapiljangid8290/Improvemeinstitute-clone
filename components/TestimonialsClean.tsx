      ...
      <div className="section-container max-w-[980px]">
        ...
        <div className="mt-8 grid items-center gap-4 lg:grid-cols-[56px_1fr_56px]">
          <button
            ...
            className="mx-auto inline-flex h-10 w-10 items-center justify-center rounded-full border border-slate-200 bg-white text-slate-400 shadow-sm transition-colors hover:text-navy-900"
          >
