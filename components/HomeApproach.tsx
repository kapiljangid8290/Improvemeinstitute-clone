...
import { homeApproachSteps } from "./home-data";
    ...
    <section id="approach" className="bg-[#f5f5f5] py-20 sm:py-24 lg:py-28">
      <div className="section-container max-w-[980px]">
        ...
        <div className="mt-10 overflow-hidden rounded-[18px] border border-slate-200 bg-white">
          {homeApproachSteps.map((step, index) => (
        ...
        <Link href="/about/" className="group mt-8 inline-flex items-center gap-2 text-[15px] font-semibold text-navy-900 transition-colors hover:text-[#3f5ca8]">
          Learn more about us <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-0.5" />
        </Link>
      </div>
    </section>
  );
