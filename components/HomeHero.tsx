...
import { homeHighlights, homeSchoolNames } from "./home-data";

export default function HomeHero() {
  const marqueeItems = [...homeSchoolNames, ...homeSchoolNames];
    ...
    <section id="home" className="relative overflow-hidden bg-[#d9d1c6] pt-20 md:pt-24">
      ...
      <div className="section-container relative z-10 flex min-h-[90vh] flex-col lg:flex-row lg:items-center">
        <div className="flex flex-1 flex-col justify-center pb-8 pt-8 lg:w-[55%] lg:pb-0 lg:pr-8 lg:pt-0">
          <div className="glass-panel rounded-[20px] p-6 sm:p-10 lg:max-w-[570px]">
            <h1 className="max-w-4xl text-left font-[var(--font-jakarta)] text-3xl font-bold leading-[1.05] tracking-tighter text-white md:text-4xl lg:text-[66px]">
              Dubai&apos;s Top Tutoring Centre - Every Curriculum from Ages 3 to 18
            </h1>
            <p className="mt-6 max-w-xl text-left text-lg leading-9 text-white/90 md:text-xl">
            ...
            <div className="mt-8 flex flex-col items-start gap-4 sm:flex-row sm:items-center">
              ...
              <Link href="/courses/" className="py-4 text-base font-medium text-white/80 transition-colors hover:text-white">
                Explore Courses
              </Link>
            </div>
            ...
            <div className="mt-10 flex items-center">
              <div className="flex flex-col border-l-4 bg-white py-3 pl-4 pr-6" style={{ borderLeftColor: "#FFC107" }}>
                <span className="text-base font-semibold text-navy-900">
                  {homeHighlights[0]} · {homeHighlights[1]}
                </span>
                <span className="text-sm font-medium text-[#3f5ca8]">{homeHighlights[2]}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="relative h-[320px] w-full flex-shrink-0 md:h-[400px] lg:h-[75vh] lg:min-h-[500px] lg:w-[45%]">
          <div className="absolute inset-0 overflow-hidden rounded-2xl shadow-[0_24px_70px_rgba(15,23,42,0.18)]">
            <video
              autoPlay
              muted
              loop
