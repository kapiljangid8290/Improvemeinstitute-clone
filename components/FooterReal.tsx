        ...
        <div className="grid gap-10 lg:grid-cols-[1.1fr_1fr_1.2fr_1fr_1fr_1.4fr]">
          <div>
            ...
            <div className="mt-4 flex gap-3">
              {[Music2, Instagram, Facebook].map((Icon, index) => (
                <span key={index} className="inline-flex h-9 w-9 items-center justify-center rounded-full bg-white/10 text-white/70">
