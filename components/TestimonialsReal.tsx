    ...
    <section id="testimonials" className="bg-[#eef2ff] py-20 sm:py-24 lg:py-28">
      <div className="section-container max-w-[980px]">
        ...
        <div className="mt-8 grid items-center gap-4 lg:grid-cols-[56px_1fr_56px]">
          <button type="button" aria-label="Previous testimonial" className="mx-auto inline-flex h-10 w-10 items-center justify-center rounded-full border border-slate-200 bg-white text-slate-400 shadow-sm">
            <ChevronLeft className="h-4 w-4" />
          </button>

          <div className="grid gap-4 md:grid-cols-3">
            {testimonials.map((item) => (
              <article key={item.name} className="rounded-[18px] border border-slate-200 bg-white p-5 shadow-[0_12px_30px_rgba(15,23,42,0.07)]">
          ...
          <button type="button" aria-label="Next testimonial" className="mx-auto inline-flex h-10 w-10 items-center justify-center rounded-full border border-slate-200 bg-white text-slate-400 shadow-sm">
        ...
        <div className="mt-8 text-center">
          <Link
            ...
            className="inline-flex items-center gap-2 text-[15px] font-semibold text-navy-900"
          >
