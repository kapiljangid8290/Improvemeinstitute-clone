          ...
          <div className="glass-panel rounded-[20px] p-6 sm:p-10">
            ...
            <div className="mt-8 flex flex-col items-start gap-4 sm:flex-row">
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 rounded-full bg-brandGold px-8 py-4 text-base font-bold text-black transition-transform hover:scale-[1.02]"
            ...
            <div className="mt-10 flex items-center">
              <div className="flex flex-col border-l-4 bg-white py-3 pl-4 pr-6" style={{ borderLeftColor: "#FFC107" }}>
                ...
                <span className="text-base font-semibold text-navy-900">{` · ${highlights[1]}`}</span>
