...
export default function HeaderReal() {
                ...
                item.label === "Our Courses" ? (
                  ...
                  >
                    ...
                    {coursesOpen ? (
                      <div
                        ...
                        className="absolute left-0 top-full w-[760px] rounded-2xl border border-slate-200 bg-white p-6 shadow-[0_24px_70px_rgba(15,23,42,0.14)]"
                      >
                                ...
                                {group.items.map((dropdownItem) => (
                                  <li key={dropdownItem.label}>
                                    <Link
                                      ...
                                      className="text-sm font-medium text-slate-700 transition-colors hover:text-yellow-600"
                                    >
                                      {dropdownItem.label}
                                    </Link>
                                  </li>
                  ...
                  >
                    <Link
                      ...
                      aria-controls="desktop-curriculum-menu"
                      aria-haspopup="true"
                    >
                      {item.label}
